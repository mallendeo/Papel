...
import { prod, hostUrl, contract } from './nebConfig'

export const callback = prod ? NebPay.config.mainnetUrl : NebPay.config.testnetUrl

export const checkExt = () => typeof window.webExtensionWallet !== 'undefined'
export const EXT_ERROR = 'WebExtensionWallet is not installed'
